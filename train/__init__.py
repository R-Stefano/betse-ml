...
def run():
    ...
    MODELS_ARCHIVE_FOLDER_PATH = 'storage/model_versions/'
    MODEL_SAVED_FOLDER_PATH = 'storage/model.pth'


    # Generators
    training_set = Dataset(folder_path = TRAIN_FOLDER_PATH, batch_size = batch_size)
    training_generator = torch.utils.data.DataLoader(training_set)

    validation_set = Dataset(folder_path = VAL_FOLDER_PATH, batch_size = batch_size)
